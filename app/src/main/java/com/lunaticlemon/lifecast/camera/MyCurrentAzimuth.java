...
public class MyCurrentAzimuth implements SensorEventListener {
    ...
    private com.lunaticlemon.lifecast.camera.OnAzimuthChangedListener mAzimuthListener;
    Context mContext;

    public MyCurrentAzimuth(com.lunaticlemon.lifecast.camera.OnAzimuthChangedListener azimuthListener, Context context) {
